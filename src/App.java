...
Evento evento1 = new Evento(titolo, dataEvento, totalePosti);
System.out.println("\n Evento creato.");
...
System.out.println("Vuoi effettuare una prenotazione? Scrivi : \n Si -  effettuare una prenotazione; \n No - non effettuare nessuna prenotazione.");
String rispostaUtente = scan.nextLine();
if(rispostaUtente.equalsIgnoreCase("Si")){
...
System.out.println("Vuoi disdire una prenotazione? Scrivi \n Si - disdire; \n No - non disdire");
String disdirePrenotazioneUtente = scan.nextLine();
if(disdirePrenotazioneUtente.equalsIgnoreCase("Si")){
    boolean prenotazioni = false;
    while(!prenotazioni){
